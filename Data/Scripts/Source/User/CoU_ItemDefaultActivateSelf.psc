ScriptName CoU_ItemDefaultActivateSelf extends ObjectReference Default
...
Group Optional_Properties
	...
	Form Property item auto Const
	{Item needed to activate trigger}
	
	int property minNeeded Auto
	{minimum number of items needed to trigger}
EndGroup
...
auto STATE Waiting
	Event onTriggerEnter(objectReference triggerRef)
		if PlayerOnly
			if triggerRef == Game.GetPlayer() && (Game.GetPlayer().GetItemCount(item) > minNeeded)
